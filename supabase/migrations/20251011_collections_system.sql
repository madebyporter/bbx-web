...
CREATE TABLE IF NOT EXISTS public.collections_sounds (
...
CREATE INDEX IF NOT EXISTS idx_collections_sounds_collection_id 
  ON public.collections_sounds(collection_id);

CREATE INDEX IF NOT EXISTS idx_collections_sounds_sound_id 
