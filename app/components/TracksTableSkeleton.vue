<template>
  <div class="w-full min-w-0 overflow-x-hidden">
    <div class="flex w-full min-w-0">
      <div class="min-w-0 flex-1 overflow-x-auto overflow-y-hidden no-scrollbar">
        <div class="w-max min-w-full h-fit">
          ...
          <div
            ...
            :key="row"
            class="text-sm border-b border-neutral-900 *:flex *:items-center *:p-4 items-center"
            :style="tableMainGridStyle"
          >
            <div class="flex items-center justify-center">
      ...
      >
        <div class="flex items-center justify-start p-4 border-b border-neutral-800 shrink-0 box-border min-h-[65px]" />
        <div
          v-for="row in rowCount"
          :key="`actions-${row}`"
          class="flex items-center justify-end p-4 border-b border-neutral-900 box-border"
        >
