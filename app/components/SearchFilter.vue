  ...
  <div ref="searchFilterRef" class="relative lg:h-20 bg-neutral-900 flex flex-col sm:flex-row gap-2 lg:gap-4 p-4 border-b border-neutral-800">
    <div class="flex flex-row gap-4 w-full justify-between lg:w-full">
      ...
      <div class="grow flex relative">
        ...
        <input ref="searchInput" type="text" v-model="searchQuery" @input="onInput" @focus="onFocus" class="font-semibold text-lg rounded-full bg-neutral-800 ring-1 ring-neutral-800 hover:ring-neutral-700 text-left p-2 lg:p-4 !pl-12 grow z-0 relative w-full lg:w-auto text-neutral-200 placeholder:text-neutral-500"
